...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-md mx-auto bg-background/50 relative shadow-2xl overflow-hidden">
      {/* Top Header */}
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-y-auto pb-24 px-4 sm:px-6 relative z-0">
        {children}
      </main>

      {/* Bottom Navigation for Mobile Feel */}
      <nav className="fixed bottom-0 w-full max-w-md bg-white/80 backdrop-blur-xl border-t border-border z-50 pb-safe">
